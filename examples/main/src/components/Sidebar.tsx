        ...
        <div className="w-80 px-4 pt-0 pb-8">
          ...
          <ul className="menu gap-1">
            <li onClick={() => navigateTo(Screen.GUIDE)}>
              <a className={currScreen === Screen.GUIDE ? 'active' : ''}><FontAwesomeIcon icon={faQuestionCircle} /> Guide</a>
            </li>
            <li onClick={() => navigateTo(Screen.MODEL)}>
              <a className={currScreen === Screen.MODEL ? 'active' : ''}><FontAwesomeIcon icon={faBrain} /> Manage models</a>
            </li>
            <li><a href="https://github.com/ngxson/wllama" target="_blank" rel="noopener"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /> Github</a></li>
          </ul>
        </div>
      </div>
    </div>
