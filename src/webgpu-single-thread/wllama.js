  ...
  makeRenderPipelineDesc: (descriptor) => {
    function makePrimitiveState(psPtr) {
      ...
      return {
        ...
        stripIndexFormat:
          WebGPU.IndexFormat[HEAPU32[((psPtr + 8) >>> 2) >>> 0]],
    ...
    function makeStencilStateFace(ssfPtr) {
      return {
        ...
        depthFailOp:
          WebGPU.StencilOperation[HEAPU32[((ssfPtr + 8) >>> 2) >>> 0]],
    ...
    function makeDepthStencilState(dssPtr) {
      ...
      return {
        ...
        depthCompare:
          WebGPU.CompareFunction[HEAPU32[((dssPtr + 12) >>> 2) >>> 0]],
    ...
    function makeVertexAttribute(vaPtr) {
      return {
        ...
        offset:
          HEAPU32[((vaPtr + 4 + 8) >>> 2) >>> 0] * 4294967296 +
          HEAPU32[((vaPtr + 8) >>> 2) >>> 0],
    ...
    function makeVertexBuffer(vbPtr) {
      ...
      return {
        arrayStride:
          HEAPU32[((vbPtr + 4 + 8) >>> 2) >>> 0] * 4294967296 +
          HEAPU32[((vbPtr + 8) >>> 2) >>> 0],
...
function _emwgpuDeviceCreateBuffer(devicePtr, descriptor, bufferPtr) {
  ...
  var desc = {
    ...
    size:
      HEAPU32[((descriptor + 4 + 24) >>> 2) >>> 0] * 4294967296 +
      HEAPU32[((descriptor + 24) >>> 2) >>> 0],
    mappedAtCreation,
  };
...
function _emwgpuInstanceRequestAdapter(
  ...
  if (options) {
    ...
    opts = {
      ...
      powerPreference:
        WebGPU.PowerPreference[HEAPU32[((options + 8) >>> 2) >>> 0]],
...
var _emwgpuWaitAny = function (futurePtr, futureCount, timeoutMSPtr) {
  ...
  return Asyncify.handleAsync(async () => {
    ...
    for (var i = 0; i < futureCount; ++i) {
      var futureId =
        HEAPU32[((futurePtr + i * 8 + 4) >>> 2) >>> 0] * 4294967296 +
        HEAPU32[((futurePtr + i * 8) >>> 2) >>> 0];
...
function _wgpuDeviceCreateBindGroup(devicePtr, descriptor) {
  ...
  function makeEntry(entryPtr) {
    ...
    if (bufferPtr) {
      ...
      return { binding, resource: WebGPU.getJsObject(samplerPtr) };
    } else {
      return { binding, resource: WebGPU.getJsObject(textureViewPtr) };
    }
  }
...
Module['_emwgpuBufferGetMappedRange'] = _emwgpuBufferGetMappedRange;
...
function assignWasmExports(wasmExports) {
  ...
  _emwgpuCreateBindGroup = Module['_emwgpuCreateBindGroup'] =
    wasmExports['emwgpuCreateBindGroup'];
  _emwgpuCreateBindGroupLayout = Module['_emwgpuCreateBindGroupLayout'] =
    wasmExports['emwgpuCreateBindGroupLayout'];
  _emwgpuCreateCommandBuffer = Module['_emwgpuCreateCommandBuffer'] =
    wasmExports['emwgpuCreateCommandBuffer'];
  _emwgpuCreateCommandEncoder = Module['_emwgpuCreateCommandEncoder'] =
    wasmExports['emwgpuCreateCommandEncoder'];
  ...
  _emwgpuCreateRenderPipeline = Module['_emwgpuCreateRenderPipeline'] =
    wasmExports['emwgpuCreateRenderPipeline'];
  _emwgpuCreateSampler = Module['_emwgpuCreateSampler'] =
    wasmExports['emwgpuCreateSampler'];
  _emwgpuCreateSurface = Module['_emwgpuCreateSurface'] =
    wasmExports['emwgpuCreateSurface'];
  _emwgpuCreateTexture = Module['_emwgpuCreateTexture'] =
    wasmExports['emwgpuCreateTexture'];
  _emwgpuCreateTextureView = Module['_emwgpuCreateTextureView'] =
    wasmExports['emwgpuCreateTextureView'];
  _emwgpuCreateAdapter = Module['_emwgpuCreateAdapter'] =
    wasmExports['emwgpuCreateAdapter'];
  _emwgpuCreateBuffer = Module['_emwgpuCreateBuffer'] =
    wasmExports['emwgpuCreateBuffer'];
  _emwgpuCreateDevice = Module['_emwgpuCreateDevice'] =
    wasmExports['emwgpuCreateDevice'];
  _emwgpuCreateQueue = Module['_emwgpuCreateQueue'] =
    wasmExports['emwgpuCreateQueue'];
  _emwgpuCreateShaderModule = Module['_emwgpuCreateShaderModule'] =
    wasmExports['emwgpuCreateShaderModule'];
  _emwgpuOnCompilationInfoCompleted = Module[
    '_emwgpuOnCompilationInfoCompleted'
  ] = wasmExports['emwgpuOnCompilationInfoCompleted'];
  ...
  _emwgpuOnWorkDoneCompleted = Module['_emwgpuOnWorkDoneCompleted'] =
    wasmExports['emwgpuOnWorkDoneCompleted'];
  ...
  __emscripten_timeout = Module['__emscripten_timeout'] =
    wasmExports['_emscripten_timeout'];
